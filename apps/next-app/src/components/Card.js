                ...
                <div className="max-w-sm rounded overflow-hidden shadow-lg dark:border-white border-4">
                    ...
                    <div className="px-6 py-4">
                        ...
                        <div className="flex justify-center">
                            <button type="button" className=" dark:bg-white  dark:text-black mx-8 my-8 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"><a href={url}>Continue</a></button>
